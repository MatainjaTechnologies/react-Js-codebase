...
const Modal = (props) => {
  ...
  return (
    <div className="overlay">
      <div className="content" style={{top:192,minWidth:'-webkit-fill-available',height:188,borderRadius:11}}>
        { closeicon() }
        {/* {props.children} */}
        <div style={{marginTop:25,textAlign:'center',fontSize: 20}}>Enter Msisdn</div><br/>
        <input type='text' className="mtext"  onChange={handlechange} placeholder='96XXXXXXX'></input>
        {checkMsisdn && <div style={{color:'green'}}>Phone number already subcscribe</div> }
        
        <button className="submitbutton"  onClick={dailysub}>Submit</button>
