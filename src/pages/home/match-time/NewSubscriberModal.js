...
import FollowGif from '../../../assetsStaging/img/htp/11.gif';
import LetsPlay from '../../../assetsStaging/img/htp/2.gif';
import Prize from '../../../assetsStaging/img/htp/3.gif';
...
const NewSubscriberModal = () =>{
    ...
    const onCloseModal = () => {
        ...
        if (checkedField == true) {
            ...
            axios.post('StageGoalyApi/popupCheck', payload).then(res => {
